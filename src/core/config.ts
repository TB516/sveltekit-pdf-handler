...
export const ResponderConfigSchema = Schema.Struct({
  ...
  /** Maximum delay between Chromium launch retries in milliseconds. */
  browserLaunchRetryMaxDelayMs: Schema.optionalKey(Schema.Finite.check(Schema.isGreaterThan(0))),
